...
describe('@EventListener', () => {
  ...
  it('should specify which event the event-handler method listens to', () => {
    const onTestCreatedEvent: string = Reflect.getMetadata(
      EVENT_LISTENER_METADATA,
      EventHandler.onTestCreated,
    );
    ...
    const onTestUpdatedEvent: string = Reflect.getMetadata(
      EVENT_LISTENER_METADATA,
      EventHandler.onTestUpdated,
    );
