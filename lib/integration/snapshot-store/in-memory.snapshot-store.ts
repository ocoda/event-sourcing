...
export class InMemorySnapshotStore extends SnapshotStore {
	...
	getSnapshot<A extends Aggregate>(snapshotStream: SnapshotStream, version: number): SnapshotEnvelope<A> {
	...
	getLastSnapshot<A extends Aggregate>(snapshotStream: SnapshotStream<A>): SnapshotEnvelope<A> {
