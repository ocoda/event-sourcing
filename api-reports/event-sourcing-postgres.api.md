## API Report File for "@ocoda/event-sourcing-postgres"
...
// dist/index.d.ts:40:5 - (ae-forgotten-export) The symbol "ISnapshot" needs to be exported by the entry point index.d.ts
