...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  ...
  <Tabs.Tab>
    <Steps>
        ### Install the core module:
        ```bash copy
        npm install add @ocoda/event-sourcing
        ```
...
While this great for testing and prototyping, you won't be able to persist the events and snapshots. If you require persistence skip to the [advanced setup](/start/module#advanced-setup).
